    ...
    return (
      <div className="min-h-screen bg-background">
        ...
        <div className="pt-32 pb-20 px-6 text-center">
          ...
          <Link to="/shop" className="inline-flex items-center gap-2 text-primary font-body text-sm uppercase tracking-widest hover:text-secondary transition-colors">
  ...
  <div className="min-h-screen bg-background overflow-hidden flex flex-col">
      ...
      <section className="relative pt-32 pb-20 px-6 flex-1">
        ...
        <div className="relative max-w-5xl mx-auto">
          <Link to="/cart" className="inline-flex items-center gap-2 text-muted-foreground font-body text-sm uppercase tracking-widest hover:text-primary transition-colors mb-8">
          ...
          <div className="grid lg:grid-cols-5 gap-12">
            ...
            <motion.div initial="hidden" animate="visible" className="lg:col-span-3 space-y-8">
              <motion.div variants={fadeUp} custom={0} className="p-8 rounded-3xl bg-gradient-to-br from-card to-muted/20 border border-primary/20 space-y-4">
                <div className="flex items-center gap-3">
                  <CreditCard className="w-5 h-5 text-primary" />
                  <h2 className="font-display text-xl text-foreground">Secure Payment</h2>
                </div>
            ...
            {/* Order summary */}
            <motion.div initial="hidden" animate="visible" variants={fadeUp} custom={0} className="lg:col-span-2">
              <div className="p-8 rounded-3xl bg-gradient-to-br from-card to-muted/10 border border-border/30 sticky top-28">
                ...
                <div className="space-y-4 mb-6">
                  {items.map((item) => (
                    <div key={item.product.id} className="flex justify-between items-start gap-4">
                      ...
                      <span className="font-body text-sm text-foreground font-medium shrink-0">
                ...
                <div className="border-t border-border/30 pt-4">
                  ...
                  {hasPhysical && (
                    <p className="font-body text-xs text-muted-foreground mt-2">+ Shipping (calculated at checkout)</p>
                  )}
                </div>
              </div>
            </motion.div>
